  ...
  if (Object.keys(TempObject).length !== 0) {
    ...
    if (
      ...
      if (roomTempState.TestState) {
        ...
        const period =
          roomTemp["28-000007d4684f"].TestHeatEnd -
          roomTemp["28-000007d4684f"].TestHeatStart;
        if (period > 0) {
          const HeatObject = {
            Period: period,
      ...
      if (roomTempState.GaraazState) {
        ...
        const period =
          roomTemp["28-0517c3a351ff"].HeatEnd -
          roomTemp["28-0517c3a351ff"].HeatStart;
        if (period > 0) {
          const HeatObject = {
            Period: period,
      ...
      if (roomTempState.EesruumState) {
        ...
        const period =
          roomTemp["28-0417c2a85dff"].HeatEnd -
          roomTemp["28-0417c2a85dff"].HeatStart;
        if (period > 0) {
          const HeatObject = {
            Period: period,
